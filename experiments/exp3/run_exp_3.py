...
We are running exp3 which is the guest simulation agentic system with just the order tracking agent. 
This system only has access to the name, persona and order_tracking through its tools.
