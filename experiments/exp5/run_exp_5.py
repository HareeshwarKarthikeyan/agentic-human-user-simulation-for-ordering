...
We are running exp5 which is full guest agent with all the tools and sub agents.
This system has access to the guest name, order tracking and message attributes generation through its tools.
This system does not need access to the past messages in the conversation.
'''
